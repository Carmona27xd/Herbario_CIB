...
try {
    ...
    $abundanceID = $_POST['abundance'] ?? null; 
    $plantClassificationID = $_POST['plantClassification'] ?? null; 
    ...
    $collectors = $_POST['collectors'] ?? null; 
    ...
    $genreID = $_POST['genre'] ?? 0; 
    $speciesID = $_POST['species'] ?? 0; 
